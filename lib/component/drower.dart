...
import 'package:e_commerce_app_project/component/purcase_list.dart';
import 'package:e_commerce_app_project/shared/sql_settign/db_helper.dart';
import 'package:e_commerce_app_project/shared/sql_settign/model.dart';
    ...
    return Drawer(
      child: ListView(children: [
        ...
        FutureBuilder(
            ...
            builder: (context,AsyncSnapshot snap) {
              if(snap.connectionState!= ConnectionState.done){
                ...
                return UserAccountsDrawerHeader(
                  accountEmail: Text("Mahmoud4123@gmail.com"),
                  accountName: Text("${
        ...
        ListTile(
          ...
          leading: Image.asset(
            "assets/images/page_view3.jpg", height: 100,width: 50,
          ),
        ),
        Divider(
          height: 10,
        ...
        ListTile(
            ...
            leading: Image.asset("assets/images/elec.jpg", height: 100,width: 50,)
        ),
        Divider(
          height: 10,
        ),
        ...
        ListTile(
            ...
            leading: Image.asset("assets/images/baby.jpg", height: 100,width: 50,)
        ),
        Divider(
          height: 10,
        ),
        ...
        ListTile(
            ...
            leading: Image.asset("assets/images/phone.jpg" , height: 100,width: 50,)
        ),
        //======== Setting===============//
        Divider(
          height: 10,
