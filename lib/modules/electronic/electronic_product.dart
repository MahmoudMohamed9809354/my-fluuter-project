...
class ElectricsProducts extends StatefulWidget {
  const ElectricsProducts({Key? key}) : super(key: key);

  @override
  _ElectricsProductsState createState() => _ElectricsProductsState();
}

class _ElectricsProductsState extends State<ElectricsProducts> {
