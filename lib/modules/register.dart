...
class _RegisterPageState extends State<RegisterPage> {
  ...
  bool passwordstabilty = true;

  bool emailNotused = true;

  FirebaseAuth auth = FirebaseAuth.instance;
  bool userfound = true;

  bool getUserfound(userfound) {
    userfound = true;
    return userfound;
  }
        ...
        Container(
          decoration: BoxDecoration(
            image: DecorationImage(
              image: AssetImage("assets/images/cover_login.jpg"),
                          ...
                          onPressed: () async {
                            if (formKey.currentState!.validate()) {
                              try {
                                ...
                                //    else if(emailRegisterController.text != "" && confirmPasswordRegisterController.text != ""){
